  ...
  plugins: [
    ...
    monkey({
      ...
      userscript: {
        ...
        'exclude-match': ['*://tricipital.com/api/*', '*://www.tricipital.com/api/*', '*://tricipital.com/assets', '*://www.tricipital.com/assets', '*://tricipital.com/assets/*', '*://www.tricipital.com/assets/*'],
        exclude: ['*://tricipital.com/assets*', '*://www.tricipital.com/assets*'],
        grant: 'none',
        'run-at': 'document-end',
      },
    }),
